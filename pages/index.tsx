  ...
  return (
    <main>
      ...
      <div className="hero section column">
        ...
        <div>
          <Image src={heroPic} alt="" layout="intrinsic" unoptimized />
        </div>
      </div>
      {/* ABOUT GIGI */}
      <div className="hero section column aboutGigi">
        <div className="image-container">
          <Image src={handsTogetherPic} alt="" layout="intrinsic" unoptimized />
        </div>
        <div>
          ...
          <p>
            ...
            Whether you're an office worker dealing with posture issues or
            someone seeking a transformative wellness retreat, my goal is to
            guide you towards a healthier, balanced life — on and off the mat.{" "}
            <br />
            <br />
            ...
            <br />
            Let’s embark on this path together, and remember — rain or shine,
            I’ll see you on the mat. Namaste.
          </p>
        </div>
      </div>
      ...
      <div className="section hero column">
        <div>
          ...
          <p>
            ...
            session is crafted to support your physical and emotional
            well-being.
          </p>
        </div>
        <div>
          {" "}
          <Image src={greenPosePic} alt="" layout="intrinsic" unoptimized />
        </div>
      </div>
      <div className="section hero column">
        <div>
          <Image src={retreatPic} alt="" layout="intrinsic" unoptimized />
        </div>
        <div>
          <h3>Yoga Retreats</h3>
          <p>
            ...
            peaceful setting. Perfect for deepening your practice while
      ...
      <div className="section hero column">
        ...
        <div>
          <Image src={waterfrontPic} alt="" layout="intrinsic" unoptimized />
        </div>
      </div>
      <div className="section hero column">
        <div>
          <Image src={teachersPic} alt="" layout="intrinsic" unoptimized />
        </div>
        <div>
